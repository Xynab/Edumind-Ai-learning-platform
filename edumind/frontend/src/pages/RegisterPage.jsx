  ...
  return (
    <div style={{ minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center",
      ...
      <div style={{ background:"var(--surface)", border:"1px solid var(--border2)", borderRadius:20,
                    padding:40, width:440, maxWidth:"95vw" }}>
        <div style={{ textAlign:"center", marginBottom:28 }}>
          ...
          <h2 style={{ fontFamily:"Syne,sans-serif", fontSize:22, fontWeight:800, marginBottom:4 }}>
            Join <span style={{ background:"linear-gradient(90deg,#7c6af7,#f472b6)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>EduMind AI</span>
          </h2>
          <p style={{ color:"var(--text3)", fontSize:13 }}>Start your AI-powered learning journey</p>
        </div>

        <form onSubmit={handle}>
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:12, marginBottom:14 }}>
            <div>
              <label style={{ fontSize:13, color:"var(--text2)", display:"block", marginBottom:5 }}>Full Name</label>
            ...
            <div>
              ...
              <input type="email" placeholder="alex@uni.edu" {...f("email")} required />
            </div>
          </div>
          <div style={{ marginBottom:14 }}>
            <label style={{ fontSize:13, color:"var(--text2)", display:"block", marginBottom:5 }}>Password</label>
            <input type="password" placeholder="Min. 8 characters" {...f("password")} required minLength={8} />
          </div>
          <div style={{ marginBottom:20 }}>
            <label style={{ fontSize:13, color:"var(--text2)", display:"block", marginBottom:5 }}>Primary Goal</label>
            <select {...f("goal")}>
          ...
          {error && (
            <div style={{ background:"rgba(248,113,113,0.12)", border:"1px solid rgba(248,113,113,0.3)",
                          borderRadius:10, padding:"10px 14px", fontSize:13, color:"var(--red)", marginBottom:14 }}>
              ⚠️ {error}
            </div>
          )}
